...
function makeNav () {
    $('.glossary__results__row').each(function(){
        ...
        $('.glossary__nav .list-inline').append('<li class="glossary__nav__item"><a class="card card__content" data-nav="'+$(this).data("term")+'" data-toggle="glossary" href="#">'+$(this).data("term")+'</a></li>');
    });
}